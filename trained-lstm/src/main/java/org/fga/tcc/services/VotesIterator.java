...
public class VotesIterator implements DataSetIterator {
    @Serial
    private static final long serialVersionUID = 2325632353081702590L;
     ...
     */
    private VotesIterator(String dataDirectory,
    ...
    public static class Builder {
        ...
        public VotesIterator build() {
            return new VotesIterator(dataDirectory,
                wordVectors,
                batchSize,
                truncateLength,
                train,
